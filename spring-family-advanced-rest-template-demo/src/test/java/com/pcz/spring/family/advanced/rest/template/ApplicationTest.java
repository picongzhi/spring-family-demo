package com.pcz.spring.family.advanced.rest.template;

import com.pcz.spring.family.advanced.rest.template.model.Coffee;
...
public class ApplicationTest {
    ...
    public void restTemplateTest() {
        ...
        ResponseEntity<List<Coffee>> coffees = restTemplate
                .exchange("http://localhost:8080/coffee", HttpMethod.GET, null, parameterizedTypeReference);
